...
# compile nginx
RUN cd /src/nginx-1.6.2 && ./configure --add-module=/src/nginx-rtmp-module-1.1.6 --with-http_ssl_module --conf-path=/config/nginx.conf --error-log-path=/logs/error.log --http-log-path=/logs/access.log
